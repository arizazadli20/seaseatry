...
export function Intelligence() {
  ...
  return (
    <section className="py-16 md:py-24 border-b border-gray-200 bg-gray-50/20">
      <div className="container mx-auto px-0 md:px-6">
        <SnapCarousel 
          ariaLabel="Intelligence Pillars" 
          desktopGridClassName="grid-cols-1 md:grid-cols-3 gap-8"
          autoAdvance={true}
        >
          {/* AI Intelligence */}
          <div className="p-8 border border-gray-200 bg-white rounded-2xl md:rounded-none flex flex-col h-full hover:border-brand-primary/30 transition-colors shadow-sm md:shadow-none">
            ...
            <div className="text-[10px] md:text-xs font-mono text-brand-primary bg-brand-primary/5 p-3 rounded border border-brand-primary/10 break-words whitespace-normal leading-relaxed">
              {ai.pipeline}
            </div>
          ...
          <div className="p-8 border border-gray-200 bg-white rounded-2xl md:rounded-none flex flex-col h-full hover:border-brand-primary/30 transition-colors shadow-sm md:shadow-none">
            ...
            <div className="text-[10px] md:text-xs font-mono text-gray-500 p-3 break-words whitespace-normal leading-relaxed">
              {satellite.note}
            </div>
          </div>
          ...
          <div className="p-8 border border-gray-200 bg-white rounded-2xl md:rounded-none flex flex-col h-full hover:border-brand-primary/30 transition-colors shadow-sm md:shadow-none">
            ...
            <div className="text-xs text-gray-500 p-3 bg-gray-50/50 rounded italic break-words whitespace-normal leading-relaxed">
